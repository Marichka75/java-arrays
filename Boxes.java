...
public class Boxes {
    public static void main(String[] args) {
        ...
        */
        ...
        String[] boxes = {"libros", "Utensilios de cocina", "Articulos de baño", "Bolsos", "Zapatos", "Cosas de verano", "Cosas de invierno"};
        ...
        for (int i = 0; i < boxes.length; i++) {
            if (boxes[i].equalsIgnoreCase(item)) {
                System.out.println(item + " están en la caja " + i + ".");
                found = true;
                break;
            }
        }
        if (!found) {
            System.out.println(item + " no las empacaste, oops!");
        }
        scanner.close();
    }
}
